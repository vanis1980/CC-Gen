...
import ctypes
ctypes.windll.kernel32.SetConsoleTitleW(f"CC Generator | github.com/TheGodVanis")
...
def main():
    ...
    / .'   \_| / .'   \_|
    | |        | |
    \ `.___.'\ \ `.___.'\  {Fore.LIGHTYELLOW_EX}github.com/TheGodVanis {Fore.YELLOW}| {Fore.LIGHTMAGENTA_EX} vanis#7713 {Fore.YELLOW}
     `.____ .'  `.____ .'
    '''
    print(sc)
    print()
